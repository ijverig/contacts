...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    listView.context = self.managedObjectContext;
...
- (NSMutableArray *)fetchContacts
{
    ...
    NSArray *imutableContacts = [self.managedObjectContext executeFetchRequest:fetchRequest error:nil];
    return [imutableContacts mutableCopy];
}
